              ...
              <div className="flex flex-col items-center gap-6">
                <div className="flex gap-4 justify-center">
                  <a
                    ...
                    className="btn-ghost !text-white !border-white/20 hover:!bg-white/10 text-sm py-2 px-4"
                  >
                    LinkedIn Profile
                  </a>
                  <a
                    ...
                    className="btn-ghost !text-white !border-white/20 hover:!bg-white/10 text-sm py-2 px-4 flex items-center"
                  >
