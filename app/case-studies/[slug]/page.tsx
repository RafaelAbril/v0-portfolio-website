      ...
      {caseStudy.testimonial && (
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <blockquote className="text-xl text-slate-700 italic mb-6">"{caseStudy.testimonial.quote}"</blockquote>
            <p className="text-slate-600 font-medium">— {caseStudy.testimonial.author}</p>
          </div>
        </section>
      )}
