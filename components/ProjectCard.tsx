...
const ProjectCard = ({ title, img, description, slug, accomplishments = [], tags = [] }: Project) => {
    ...
    const CardContent = (
        <div
            ref={cardRef}
            className={`group bg-card rounded-xl shadow-sm border border-border hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 overflow-hidden ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                }`}
        >
