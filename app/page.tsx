        ...
        <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-primary text-primary-foreground scroll-mt-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col items-center gap-12">
              <div className="w-full max-w-xl mx-auto bg-primary-foreground/5 rounded-2xl p-6 sm:p-8 backdrop-blur-sm border border-primary-foreground/10 text-left">
                <ContactForm />
              </div>

              <div className="flex flex-col items-center gap-6 w-full">
                <p className="text-lg opacity-80">Or connect directly</p>
